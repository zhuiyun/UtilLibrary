...
public class NightRelativeLayoutWhite extends RelativeLayout {
    public NightRelativeLayoutWhite(Context context) {
        this(context, null);
    }

    public NightRelativeLayoutWhite(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NightRelativeLayoutWhite(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public NightRelativeLayoutWhite(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
