...
public class NightRelativeLayoutRadius extends RelativeLayout {
    Drawable bright;
    Drawable dark;

    public NightRelativeLayoutRadius(Context context) {
        this(context, null);
    }

    public NightRelativeLayoutRadius(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NightRelativeLayoutRadius(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public NightRelativeLayoutRadius(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
