...
public class NightScrollViewRadius extends NestedScrollView {
    Drawable bright;
    Drawable dark;

    public NightScrollViewRadius(Context context) {
        this(context, null);
    }

    public NightScrollViewRadius(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NightScrollViewRadius(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
