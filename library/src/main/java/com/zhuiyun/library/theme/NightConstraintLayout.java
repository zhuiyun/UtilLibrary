...
public class NightConstraintLayout extends ConstraintLayout {
    Drawable dark;
    Drawable bright;
    ...
    public NightConstraintLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NightConstraintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public NightConstraintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
